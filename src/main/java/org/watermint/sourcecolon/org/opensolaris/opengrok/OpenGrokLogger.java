...
public final class OpenGrokLogger {
    ...
    private static final Logger log = Logger.getLogger("org.watermint.sourcecolon.org.opensolaris.opengrok");
    ...
    public static void setOGConsoleLogLevel(Level level) {
        for (Enumeration<String> e = LogManager.getLogManager().getLoggerNames();
            ...
            if (!loggerName.startsWith("org.watermint.sourcecolon.org.opensolaris.opengrok")) {
                for (Handler hi : h) {
