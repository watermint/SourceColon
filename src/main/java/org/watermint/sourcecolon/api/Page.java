...
public class Page {
    ...
    public List<Map<Long,String>> getList(@PathParam("hash") String pageHash, @PathParam("start") long start, @PathParam("end") long end) {
        ...
        try {
            ...
            q.setRows(countRows);
            q.setQuery("path_hash:" + pageHash + " AND text_seq:[" + start + " TO " + end + "]");
